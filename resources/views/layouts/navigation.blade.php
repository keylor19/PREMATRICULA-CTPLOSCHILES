            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if (Auth::user()->esAdmin())
                        ...
                        <x-nav-link :href="route('prematricula.index')" :active="request()->routeIs('prematricula.*') && !request()->routeIs('admin.*')">
                            Matricular
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('admin.modalidades.index')" :active="request()->routeIs('admin.modalidades.*')">
                            Modalidades
                        </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="px-4 py-2 text-xs text-gray-400">
                            {{ Auth::user()->esAdmin() ? 'Administrador' : 'Docente' }}
                        </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->esAdmin())
                ...
                <x-responsive-nav-link :href="route('prematricula.index')" :active="request()->routeIs('prematricula.*') && !request()->routeIs('admin.*')">
                    Matricular
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('admin.modalidades.index')" :active="request()->routeIs('admin.modalidades.*')">
                    Modalidades
                </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-xs text-gray-400">{{ Auth::user()->esAdmin() ? 'Administrador' : 'Docente' }}</div>
            </div>
