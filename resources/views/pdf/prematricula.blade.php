...
<body>
    ...
    <div class="contenido">
        ...
        <div class="titulo-principal">
            <h1>PREMATRÍCULA: {{ mb_strtoupper($prematricula->modalidad->nombre ?? '', 'UTF-8') }} {{ $prematricula->periodo->anio ?? now()->addYear()->year }}</h1>
...
@endif
@if ($prematricula->carreraCuartaOpcion)
    <tr>
        <td colspan="2">Cuarta opción: <strong>{{ $prematricula->carreraCuartaOpcion->nombre }}</strong></td>
    </tr>
@endif
    </table>
@else
            {{-- Diurna: sección y talleres --}}
            <table class="nivel-info">
                <tr>
